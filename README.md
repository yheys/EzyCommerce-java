...
('Samsung TV', 499.99, 5);
3. Update your password in DBConnection.java
private static final String PASSWORD = "your_password";
4. Download MySQL JDBC Connector
Place the JDBC connector in the lib/ directory.
Application Flow
App Starts
│
├── Customer
...
orders.txt
Saved order history
receipts/order_X.txt
Text receipt
receipts/order_X.dat
Binary receipt
receipts/order_X.ser
